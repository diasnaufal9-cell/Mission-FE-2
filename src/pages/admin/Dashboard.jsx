        ...
        <div>
            <div className="flex justify-between items-center mb-8">
                ...
                <button 
                    ...
                    className="px-4 py-2 border border-red-400 text-red-500 rounded-lg hover:bg-red-50 transition-colors"
                >
                    Logout
                </button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div className="space-y-6">
                        ...
                        <div key={activity.id} className="flex gap-4 group">
                            <div className="flex flex-col items-center">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${activity.type === "user" ? "bg-blue-100" : "bg-purple-100"}`}>
                                    <svg
                                        className={`w-4 h-4 ${activity.type === "user" ? "text-blue-500" : "text-purple-500"}`}
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    >
                    ...
                    {activities.length === 0 && (
                        <p className="text-center text-gray-400 py-8">Tidak ada aktivitas terbaru.</p>
                    )}
                </div>
            </div>
        </div>
